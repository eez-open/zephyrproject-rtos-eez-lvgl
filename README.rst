...
EEZ Studio GUI created LVGL Sample
#################

Overview
********

This sample application displays "Click me" in the center of the screen
If button is clicked it opens next page.
https://github.com/eez-open/studio
Everything is copyed from lvgl sample CMakeFile is changed to compile eez-framework, and minor changes are added to main.c
